...
**Girgit** is a multiplayer hide-and-seek game built in **Godot 4.6**, inspired
by *MECCHA GIRGIT*. Hiders are plain white bipedal blobs who **paint themselves**
(any color, per body part, with gloss control and a world-color eyedropper) and
**strike poses** to melt into the environment. The **seeker** stalks the map with
a gun and has to find and shoot every hider before the timer runs out.
